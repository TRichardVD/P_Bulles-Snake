...
- ## Variables
	- ### const
		- Ne peux PAS être modifié (attention dans le cas d'un objet la référence de l'objet ne peut pas être modifié mais sans contenu oui ! comme on peut le comprendre en comprenant le schéma [ici](logseq://graph/_NotesEcole?block-id=6744c094-549f-405d-9f51-45ce031cf9de)
	...
	- ### Spécificités du langage
		- ![memory-management-in-js.png](../assets/memory-management-in-js_1732559050326_0.png)
